            ...
            Timer.after(1.5, function()
                ...
                :finish(function()
                    ...
                    if self.playerPokemon.currentExp > self.playerPokemon.expToLevel then
                        ...
                        local OGstats = self.playerPokemon:getStats()
                        local statsIncrease = self.playerPokemon:levelUp()
                        local newStats = self.playerPokemon:getStats()

                        gStateStack:push(BattleMessageState('Congratulations! Level Up!',
                        function()
                            gStateStack:push(StatsMenuState(OGstats, statsIncrease, newStats,
                            function()
                                self:fadeOutWhite()
                            end))
